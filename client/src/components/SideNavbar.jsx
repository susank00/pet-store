          ...
          <ul className="space-y-2 font-medium">
            ...
            <li className="relative">
              <span
                ...
                className="flex items-center text-gray-200 cursor-pointe"
              >
                <svg
                  className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                  aria-hidden="true"
                ...
                <span className="ms-3 ">E-commerceeee</span>
              </span>
              {isOpen && (
                <div
                  id="dropdown"
                  className="absolute z-10 bg-transparent divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700"
                >
                  <ul
