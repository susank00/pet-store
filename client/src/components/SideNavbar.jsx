...
const SideNavbar = () => {
  ...
  const toggleEcommerceDropdown = () => {
    ...
    setIsUsersOpen(false); // Close the users dropdown when opening ecommerce dropdown
  };

  const toggleUsersDropdown = () => {
    setIsUsersOpen(!isUsersOpen);
    setIsEcommerceOpen(false); // Close the ecommerce dropdown when opening users dropdown
  };
  return (
    <>
      <button
      ...
      <aside
        id="default-sidebar"
        className=" absolute h-full left-0  w-64  bg-gray-800 dark:bg-gray-900 z-0 overflow-y-auto"
        aria-label="Sidebar"
      >
        {/* <div className="h-full flex flex-col justify-between"> */}
        {/* <div className="flex h-full mt-5 px-3 py-4 overflow-y-auto bg-gray-900 dark:bg-gray-900"> */}
